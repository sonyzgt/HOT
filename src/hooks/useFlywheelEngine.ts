...
const getInitialState = (cfg: MachineConfig): FlywheelState => {
  ...
  return {
    ...
    phaseProgress: 0,
    cycleCount: 2,
    totalFeesClaimedETH: 0.2389,
    totalFeesClaimedUSD: 597.25,
    totalTokensBoughtBack: 51749985,
    totalTokensBurned: 51749985,
    burnedPercentageOfSupply: 5.175,
