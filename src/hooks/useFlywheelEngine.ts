...
const getInitialState = (cfg: MachineConfig): FlywheelState => {
  ...
  return {
    ...
    phaseProgress: 0,
    cycleCount: 3,
    totalFeesClaimedETH: 0.2780,
    totalFeesClaimedUSD: 695.0,
    totalTokensBoughtBack: 55728648,
    totalTokensBurned: 55728648,
    burnedPercentageOfSupply: 5.57,
